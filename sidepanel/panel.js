...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  document.getElementById('btn-link-components').addEventListener('click', () => {
    ...
    // AI Wizard Toggle (Collapse/Expand)`n  const wizardHeader = document.querySelector('.wizard-header');`n  if (wizardHeader) {`n    wizardHeader.addEventListener('click', () => {`n      document.getElementById('ai-wizard-section').classList.toggle('collapsed');`n    });`n  }`n`n    // AI Wizard Toggle (Collapse/Expand)`r`n  const wizardHeader = document.querySelector('.wizard-header');`r`n  if (wizardHeader) {`r`n    wizardHeader.addEventListener('click', () => {`r`n      document.getElementById('ai-wizard-section').classList.toggle('collapsed');`r`n    });`r`n  }`r`n`r`n    // AI Wizard Toggle (Collapse/Expand)`r`n  const wizardHeader = document.querySelector('.wizard-header');`r`n  if (wizardHeader) {`r`n    wizardHeader.addEventListener('click', () => {`r`n      document.getElementById('ai-wizard-section').classList.toggle('collapsed');`r`n    });`r`n  }`r`n`r`n  await runDiagnostics();
